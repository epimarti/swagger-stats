...
swsCoreStats.prototype.initializePromClient = function () {
    var metricsConfig = swsUtil.swsMetrics(this.options)
    this.promClientMetrics.api_all_request_total = new promClient.Counter({
        name: metricsConfig.api_all_request_total.name,
        help: metricsConfig.api_all_request_total.help
    });

    this.promClientMetrics.api_all_success_total = new promClient.Counter({
        name: metricsConfig.api_all_success_total.name,
        help: metricsConfig.api_all_success_total.help
    });
    this.promClientMetrics.api_all_errors_total = new promClient.Counter({
        name: metricsConfig.api_all_errors_total.name,
        help: metricsConfig.api_all_errors_total.help
    });
    this.promClientMetrics.api_all_client_error_total = new promClient.Counter({
        name: metricsConfig.api_all_client_error_total.name,
        help: metricsConfig.api_all_client_error_total.help
    });
    this.promClientMetrics.api_all_server_error_total = new promClient.Counter({
        name: metricsConfig.api_all_server_error_total.name,
        help: metricsConfig.api_all_server_error_total.help
    });
    this.promClientMetrics.api_all_request_in_processing_total = new promClient.Gauge({
        name: metricsConfig.api_all_request_in_processing_total.name,
        help: metricsConfig.api_all_request_in_processing_total.help
    });

    this.promClientMetrics.nodejs_process_memory_rss_bytes = new promClient.Gauge({
        name: metricsConfig.nodejs_process_memory_rss_bytes.name,
        help: metricsConfig.nodejs_process_memory_rss_bytes.help
    });
    this.promClientMetrics.nodejs_process_memory_heap_total_bytes = new promClient.Gauge({
        name: metricsConfig.nodejs_process_memory_heap_total_bytes.name,
        help: metricsConfig.nodejs_process_memory_heap_total_bytes.help
    });
    this.promClientMetrics.nodejs_process_memory_heap_used_bytes = new promClient.Gauge({
        name: metricsConfig.nodejs_process_memory_heap_used_bytes.name,
        help: metricsConfig.nodejs_process_memory_heap_used_bytes.help
    });
    this.promClientMetrics.nodejs_process_memory_external_bytes = new promClient.Gauge({
        name: metricsConfig.nodejs_process_memory_external_bytes.name,
        help: metricsConfig.nodejs_process_memory_external_bytes.help
    });
    this.promClientMetrics.nodejs_process_cpu_usage_percentage = new promClient.Gauge({
        name: metricsConfig.nodejs_process_cpu_usage_percentage.name,
        help: metricsConfig.nodejs_process_cpu_usage_percentage.help
    });
}
...
swsCoreStats.prototype.calculateSystemStats = function (ts, totalElapsedSec) {
    ...
    console.log('system', this.promClientMetrics)
...
swsCoreStats.prototype.countRequest = function (req, res) {
    ...
    console.log('countRequest', this.promClientMetrics)
    // Update prom-client metrics
...
swsCoreStats.prototype.countResponse = function (res) {
    ...
    console.log('countResponse', this.promClientMetrics)
