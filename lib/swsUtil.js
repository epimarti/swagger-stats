...
module.exports.supportedOptions = {
    ...
    // Prefix for Prometheus metrics. Default is "api_"
    prometheusMetricsPrefix: "prometheusMetricsPrefix",

    // Enable user label on Prometheus metrics. Default false.
    prometheusTraceCallByUser: "prometheusTraceCallByUser",

    // Callback to get calling user name for Prometheus metrics.
    // If user label is enabled (option prometheusTraceCallByUser=true),
    // Application must implement getUserName to get user name
    // the following parameters are passed to this callback:
    // getUserName(req)
    // - req - request
...
module.exports.swsMetrics = function (swsOptions) {
    var prefix = swsOptions.prometheusMetricsPrefix
    return {

        // TOP level counters for all requests / responses, no labels
        api_all_request_total: { name: prefix + 'all_request_total', type: 'counter', help: 'The total number of all API requests received' },
        api_all_success_total: { name: prefix + 'all_success_total', type: 'counter', help: 'The total number of all API requests with success response' },
        api_all_errors_total: { name: prefix + 'all_errors_total', type: 'counter', help: 'The total number of all API requests with error response' },
        api_all_client_error_total: { name: prefix + 'all_client_error_total', type: 'counter', help: 'The total number of all API requests with client error response' },
        api_all_server_error_total: { name: prefix + 'all_server_error_total', type: 'counter', help: 'The total number of all API requests with server error response' },
        api_all_request_in_processing_total: { name: prefix + 'all_request_in_processing_total', type: 'gauge', help: 'The total number of all API requests currently in processing (no response yet)' },

        // System metrics for node process
        nodejs_process_memory_rss_bytes: { name: prefix + 'nodejs_process_memory_rss_bytes', type: 'gauge', help: 'Node.js process resident memory (RSS) bytes ' },
        nodejs_process_memory_heap_total_bytes: { name: prefix + 'nodejs_process_memory_heap_total_bytes', type: 'gauge', help: 'Node.js process memory heapTotal bytes' },
        nodejs_process_memory_heap_used_bytes: { name: prefix + 'nodejs_process_memory_heap_used_bytes', type: 'gauge', help: 'Node.js process memory heapUsed bytes' },
        nodejs_process_memory_external_bytes: { name: prefix + 'nodejs_process_memory_external_bytes', type: 'gauge', help: 'Node.js process memory external bytes' },
        nodejs_process_cpu_usage_percentage: { name: prefix + 'nodejs_process_cpu_usage_percentage', type: 'gauge', help: 'Node.js process CPU usage percentage' },

        // API Operation counters, labeled with method, path and code
        api_request_total: { name: prefix + 'request_total', type: 'counter', help: 'The total number of all API requests' },

        // DISABLED API Operation counters, labeled with method, path and codeclass
        //api_request_codeclass_total: { name: prefix + 'request_codeclass_total', type: 'counter', help: 'The total number of all API requests by response code class'},

        // API request duration histogram, labeled with method, path and code
        api_request_duration_milliseconds: { name: prefix + 'request_duration_milliseconds', type: 'histogram', help: 'API requests duration' },

        // API request size histogram, labeled with method, path and code
        api_request_size_bytes: { name: prefix + 'request_size_bytes', type: 'histogram', help: 'API requests size' },

        // API response size histogram, labeled with method, path and code
        api_response_size_bytes: { name: prefix + 'response_size_bytes', type: 'histogram', help: 'API requests size' }
    }
};
