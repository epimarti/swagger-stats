...
swsAPIStats.prototype.initializePromClient = function () {
    var metricsConfig = swsUtil.swsMetrics(this.options)
    console.log('swsAPIStats.initializePromClient', this.options, metricsConfig)
    var labelNames = this.options.prometheusTraceCallByUser
...
swsAPIStats.prototype.countResponse = function (res) {
    ...
    if (this.options.prometheusTraceCallByUser) {
